 ...
 *
 * @author 徐俊
 * @date zhoujunxia on 2018/8/31 16:05
 */
public class SwitchServiceWorkerAndTimeEvent {
    ...
    public SwitchServiceWorkerAndTimeEvent(AppointWorker appointWorker, String appointment, int dayposition, int pickup, ItemToMorePet itemToMorePet,String workerIds) {
    ...
    public SwitchServiceWorkerAndTimeEvent() {
    }
}
