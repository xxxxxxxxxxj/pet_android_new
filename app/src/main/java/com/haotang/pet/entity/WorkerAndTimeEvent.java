 ...
 *
 * @author 徐俊
 * @date zhoujunxia on 2018/8/23 18:08
 */
public class WorkerAndTimeEvent {
    ...
    public WorkerAndTimeEvent(AppointWorker appointWorker, String appointment, int dayposition, int pickup, ItemToMorePet itemToMorePet,String workerIds) {
