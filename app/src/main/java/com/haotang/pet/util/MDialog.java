...
public class MDialog extends Dialog {
    ...
    private void initControls() {
        ...
        if (0 != msgTextColorId)
            tvMessage.setTextColor(msgTextColorId);
        ...
        if (nDialogTitleShow == 1) {//罐头币用的。别的弹窗用不到 0 不显示 1 显示 title
            tvTitle.setVisibility(View.VISIBLE);
//			tvTitle.setTextColor(Color.parseColor("#333333"));
            btOK.setTextColor(Color.parseColor("#BB996C"));
        }
    }

    public void setTitleShow(int nDialogTitleShow) {
        this.nDialogTitleShow = nDialogTitleShow;
    }
    ...
    public void setMsgTextColor(int colorid) {
        this.msgTextColorId = colorid;
    }
    ...
    public static class Builder {
        ...
        private int okColorId, cancelColorId,msgTextColorId;
        private int titleColorId;
        private int nDialogType = DIALOGTYPE_ALERT;
        private int nDialogTitleShow;
        ...
        public Builder setTitleShow(int nType) {
            this.nDialogTitleShow = nType;
            return this;
        }
        ...
        public Builder setMsgTextColor(int colorid) {
            this.msgTextColorId = colorid;
            return this;
        }
        ...
        public MDialog build() {
            ...
            md.setTitleShow(nDialogTitleShow);
            md.setTitleTextColor(titleColorId);
            md.setMessage(strMessage);
            md.setOkStr(strOK);
            md.setCancelStr(strCancel);
            md.setOkTextColor(okColorId);
            md.setMsgTextColor(msgTextColorId);
