...
import static com.haotang.pet.luban.Preconditions.checkNotNull;
...
public class Luban {
    ...
    private File thirdCompress(@NonNull File file) {
        String thumb = mCacheDir.getAbsolutePath() + "/" + System.currentTimeMillis()+ ".png";
