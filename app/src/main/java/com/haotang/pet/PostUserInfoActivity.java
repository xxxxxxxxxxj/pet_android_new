...
public class PostUserInfoActivity extends SuperActivity implements
	...
	private ImageView sriv_postuser_info_userimg;
					...
					if (jobj.has("data") && !jobj.isNull("data")) {
						...
						if (data != null) {
							...
							if (duty == 1 || duty == 2) {
								...
								if (userMemberLevel != null) {
									...
									if (memberIcon != null
										...
										GlideUtil.loadImg(PostUserInfoActivity.this,memberIcon,
												iv_postuser_info_level,
							...
							Utils.setStringText(tv_postuser_info_tz, postAmount
									+ "");
							GlideUtil.loadRoundImg(PostUserInfoActivity.this,avatar,sriv_postuser_info_userimg,R.drawable.icon_self,5);
							// 帖子列表
	...
	private void initView() {
		...
		sriv_postuser_info_userimg = (ImageView) findViewById(R.id.sriv_postuser_info_userimg);
