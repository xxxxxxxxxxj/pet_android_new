...
public class VideoPlayerActivity extends SuperActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgWidth = getIntent().getIntExtra("imgWidth", 0);
        if (!Utils.isStrNull(mPath)) {
            finish();
            return;
        }
        ...
        /*if (imgHeight > 0 && imgWidth > 0 && imgHeight > imgWidth) {
            mVideoView.getLayoutParams().width = DisplayUtil.getWindowWidth(this);
            mVideoView.getLayoutParams().height = (int) ComputeUtil.mul(DisplayUtil.getWindowWidth(this), ComputeUtil.div(imgHeight, imgWidth));
        }*/
