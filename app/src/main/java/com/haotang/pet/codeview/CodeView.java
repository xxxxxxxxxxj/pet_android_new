...
public class CodeView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            dividerWidth = 1;
            code = "";
            codeColor = Color.parseColor("#737A83");
            pointRadius = Util.dpToPx(getContext(), 5);
            ...
            codeColor = typedArray.getColor(R.styleable.CodeView_codeColor, Color.parseColor("#737A83"));
            pointRadius = typedArray.getDimensionPixelSize(R.styleable.CodeView_pointRadius, Util.dpToPx(getContext(), 5));
            showType = typedArray.getInt(R.styleable.CodeView_showType, SHOW_TYPE_WORD);
            textSize = typedArray.getDimensionPixelSize(R.styleable.CodeView_cvTextSize, 0);
        }
    }
