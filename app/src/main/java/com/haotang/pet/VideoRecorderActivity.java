...
import com.haotang.pet.videoecorder.MediaUtils;
import com.haotang.pet.videoecorder.widget.SendView;
import com.haotang.pet.videoecorder.widget.VideoProgressBar;
...
public class VideoRecorderActivity extends SuperActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        params.height = ScreenUtil.getScreenShowHeight(this) - ScreenUtil.getScreenWidth(this);
        rl_bottom.setLayoutParams(params);
        // setting
        mediaUtils = new MediaUtils(this);
        mediaUtils.setRecorderType(MediaUtils.MEDIA_VIDEO);
        PetVideo = new File(Environment.getExternalStorageDirectory(), "PetVideo");
        if (!PetVideo.exists()) {
            PetVideo.mkdirs();
        }
        mediaUtils.setTargetDir(PetVideo);
...
//        view = (TextView) findViewById(R.id.view);
    ...
    private View.OnClickListener selectClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            send.stopAnim();
            recordLayout.setVisibility(View.VISIBLE);
            EventBus.getDefault().post(new VideoEvent(true, path, 0));
            finish();
        }
    };
}
