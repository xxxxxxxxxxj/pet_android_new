...
public class MyTimeOutCouponActivity extends SuperActivity {
    public static MyTimeOutCouponActivity timeOutCouponActivity;
    private ImageButton ib_titlebar_back;
    private TextView tv_titlebar_title;
    private PullToRefreshListView listView_show_mycoupon;
    private CouponTimeOutAdapter adapter;
    ...
    private void setData() {
                adapter = new CouponTimeOutAdapter(MyTimeOutCouponActivity.this, MyCouponCanUseList);
    ...
    private void getAllCoupons(int page) {
        ...
        CommUtil.getMyCouponAll(
                SharedPreferenceUtil.getInstance(MyTimeOutCouponActivity.this)
                        ...
                        .getIMEI(MyTimeOutCouponActivity.this), MyTimeOutCouponActivity.this, page, 1,
                queryUserCoupons);
    }
    ...
    public void setNoticeMyCouponList(int position, MyCouponCanUse canUse) {
        canUse.isOpen = !canUse.isOpen;
        MyCouponCanUseList.set(position, canUse);
        adapter.notifyDataSetChanged();
    }
}
