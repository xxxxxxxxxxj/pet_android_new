...
public class MlvItemPostselectionDetailAdapter<T> extends CommonAdapter<T> {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		ImageView sriv_item_mlvitempostselectionadapter = viewHolder
		...
		if (flag == 1) {
			...
			if (commentsBean != null) {
				...
				if (user != null) {
					...
					GlideUtil.loadRoundImg(mContext, avatar, sriv_item_mlvitempostselectionadapter, R.drawable.icon_self, 5);
				}
			}
		}
