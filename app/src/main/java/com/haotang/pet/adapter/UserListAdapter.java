...
public class UserListAdapter<T> extends CommonAdapter<T> {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		ImageView sriv_item_uerlist_userimg = viewHolder
		...
		GlideUtil.loadRoundImg(mContext, avatar, sriv_item_uerlist_userimg,
		...
		if (duty == 1 || duty == 2) {
			...
			if (memberIcon != null && !TextUtils.isEmpty(memberIcon)) {
				GlideUtil.loadImg(mContext,memberIcon, iv_uerlist_level,
