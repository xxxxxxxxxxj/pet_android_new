...
public class HlvItemPostselectionDetailAdapter<T> extends CommonAdapter<T> {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		ImageView sriv_item_hlvitempostselectionadapter = viewHolder
		...
		if (flowerUsersBean != null) {
			...
			GlideUtil.loadRoundImg(mContext, avatar, sriv_item_hlvitempostselectionadapter, R.drawable.jingxuan_flower_icon, 5);
		}
