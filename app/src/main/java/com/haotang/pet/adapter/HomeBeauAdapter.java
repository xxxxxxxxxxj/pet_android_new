 ...
 */
public class HomeBeauAdapter extends BaseQuickAdapter<Beautician, BaseViewHolder> {

    public HomeBeauAdapter(int layoutResId, List<Beautician> data) {
    ...
    protected void convert(final BaseViewHolder helper, final Beautician item) {
        ...
        if (item != null) {
            ...
            Utils.setText(tv_item_serchbeau_time, item.earliest, "", View.VISIBLE, View.GONE);
            if (item.gender == 1) {
