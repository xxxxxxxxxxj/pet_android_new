...
public class CustomStatusView extends View {
    ...
    public CustomStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        progressColor = array.getColor(R.styleable.CustomStatusView_progress_color, ContextCompat.getColor(context, R.color.aBB996C));
        loadSuccessColor = array.getColor(R.styleable.CustomStatusView_load_success_color, ContextCompat.getColor(context, R.color.aBB996C));
