...
public class AlertDialogDefault {
    ...
    private ImageView iv_defaultdialog_close;
    ...
    public AlertDialogDefault builder() {
        ...
        // 获取自定义Dialog布局中的控件
        iv_defaultdialog_close = (ImageView) view
                .findViewById(R.id.iv_defaultdialog_close);
        ...
        iv_defaultdialog_close.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public AlertDialogDefault setTitle(String title) {
        Utils.setText(tv_defaultdialog_title, title, "", View.VISIBLE, View.GONE);
        return this;
    }

    public AlertDialogDefault setCloseVisible(int visibility) {
        iv_defaultdialog_close.setVisibility(visibility);
        return this;
    }

    public AlertDialogDefault setMsg(CharSequence msg) {
        Utils.setText(tv_defaultdialog_msg, msg, "", View.VISIBLE, View.GONE);
        return this;
    }
