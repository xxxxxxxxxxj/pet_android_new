...
public class AlertDialogNavAndPost {
	...
	private CenterTextView txt_subtitle;
	private CenterTextView txt_msg;
	...
	public AlertDialogNavAndPost builder() {
		...
		txt_subtitle = (CenterTextView) view.findViewById(R.id.txt_subtitle);
		txt_msg = (CenterTextView) view.findViewById(R.id.txt_msg);
	...
	public AlertDialogNavAndPost setSubTitle(String title) {
		if ("".equals(title)) {
	...
	public AlertDialogNavAndPost setNegativeButtonVisible(int visibility) {
		btn_neg.setVisibility(visibility);
		img_line.setVisibility(visibility);
		return this;
	}

	public AlertDialogNavAndPost setPositiveButtonVisible(int visibility) {
