...
import com.haotang.pet.view.bannerview.DisplayUtil;
...
public class QMUIPopup extends QMUIBasePopup {
    ...
    public void setContentView(View root) {
        @SuppressLint("InflateParams") LinearLayout layout = (LinearLayout) LayoutInflater.from(mContext)
                .inflate(getRootLayout(), null, false);
        LinearLayout ll_pop_root = (LinearLayout) layout.findViewById(R.id.ll_pop_root);
        mArrowDown = (ImageView) layout.findViewById(R.id.arrow_down);
        mArrowUp = (ImageView) layout.findViewById(R.id.arrow_up);
        LinearLayout box = (LinearLayout) layout.findViewById(R.id.box);
        box.addView(root);
