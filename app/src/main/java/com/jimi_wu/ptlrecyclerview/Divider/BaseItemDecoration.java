...
public class BaseItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public BaseItemDecoration(Context mContext, int res) {
        ...
        this.mHeight = mDivider.getIntrinsicHeight() <= 0 ? dp2px(3) : mDivider.getIntrinsicHeight();
        this.mWidth = mDivider.getIntrinsicWidth() <= 0 ? dp2px(3) : mDivider.getIntrinsicWidth();
    }
