...
public class JZVideoPlayerStandard extends JZVideoPlayer {
    ...
    public void setSizeVideo(String videoSize){
        if (!TextUtils.isEmpty(videoSize)){
            textview_Size.setText(videoSize);
        }else {
    ...
    public void setAllControlsVisiblity(int topCon, int bottomCon, int startBtn, int loadingPro,
        ...
        if (thumbImg == View.VISIBLE){
            start_layout.setBackgroundResource(R.drawable.click_play);
            textview_Size.setVisibility(thumbImg);
        }else {
            start_layout.setBackgroundColor(Color.parseColor("#00000000"));
            textview_Size.setVisibility(View.GONE);
        }
